...
var moduleMap = { "Extension": () => {
	dynamicLoadingCss(["style-BundUD32.css"], false, "Extension");
	return __federation_import("./__federation_expose_Extension-CV_LONod.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
} };
var seen = {};
