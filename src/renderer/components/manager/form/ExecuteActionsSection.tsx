...
import {CustomExecuteActions} from '@lynx_extension/common/types';
import {extractTemplateVariables} from '@lynx_extension/common/utils';
...
import {AddExeButton} from './AddExeButton';
import {AddScriptButton} from './AddScriptButton';

export function ExecuteActionsSection() {
...
export default ExecuteActionsSection;
