...
import {hasTemplateVariables, resolvePathShortcuts} from '@lynx_extension/common/utils';
import {
  CustomActionsModal,
  SafetyConfirmationModal,
  VariablePromptModal,
} from '@lynx_extension/renderer/components/modals';
import {reducerActions, selectRunningExecutions, selectSystemPaths} from '@lynx_extension/renderer/store';
    ...
    (targetCard: CustomCard) => {
      ...
      const manageUrls = (ptyId: string, onDone?: () => void) => {
        ...
        if ((urlConfig.type === 'custom' || urlConfig.type === 'htmlFile') && urlConfig.customUrl) {
          ...
          // Start URL catching session in redux (handled by useCustomActionsLifecycle)
