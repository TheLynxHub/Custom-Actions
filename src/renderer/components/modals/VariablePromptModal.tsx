...
import {CustomCard, TemplateVariable} from '@lynx_extension/common/types';
import {extractCardVariables, substituteCardVariables} from '@lynx_extension/common/utils';
import {
  CheckCircleIcon,
  CopyIcon,
  PlayCircleIcon,
