...
import {sanitizeCards} from '@lynx_extension/common/utils';
...
import {CustomActionsManager} from '../manager/CustomActionsManager';

type Props = {state: UseOverlayStateReturn};

export function CustomActionsModal({state}: Props) {
